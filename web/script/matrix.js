...
function form_Plus_minusMatrix(){
    ...
    if(size == 2){
        ...
        document.getElementById("plus_minus_matrix").innerHTML = "<div class='row'><div class='col-lg-6 text-center'>matrix A (3x3)<div class='row d-flex justify-content-center'><input type='text' name='matA_11' class='form-control m-1' style='width:100px;'> <input type='text' name='matA_12' class='form-control m-1' style='width:100px;'> <input type='text' name='matA_13' class='form-control m-1' style='width:100px;'></div><div class='row d-flex justify-content-center'><input type='text' name='matA_21' class='form-control m-1' style='width:100px;'> <input type='text' name='matA_22' class='form-control m-1' style='width:100px;'> <input type='text' name='matA_23' class='form-control m-1' style='width:100px;'></div><div class='row d-flex justify-content-center'><input type='text' name='matA_31' class='form-control m-1' style='width:100px;'> <input type='text' name='matA_32' class='form-control m-1' style='width:100px;'> <input type='text' name='matA_33' class='form-control m-1' style='width:100px;'></div></div><div class='col-lg-6 text-center'>matrix B (3x3)<div class='row d-flex justify-content-center'><input type='text' name='matB_11' class='form-control m-1' style='width:100px;'> <input type='text' name='matB_12' class='form-control m-1' style='width:100px;'> <input type='text' name='matB_13' class='form-control m-1' style='width:100px;'></div><div class='row d-flex justify-content-center'><input type='text' name='matB_21' class='form-control m-1' style='width:100px;'> <input type='text' name='matB_22' class='form-control m-1' style='width:100px;'> <input type='text' name='matB_23' class='form-control m-1' style='width:100px;'></div><div class='row d-flex justify-content-center'><input type='text' name='matB_31' class='form-control m-1' style='width:100px;'> <input type='text' name='matB_32' class='form-control m-1' style='width:100px;'> <input type='text' name='matB_33' class='form-control m-1' style='width:100px;'></div></div></div><hr><div class='col-lg-12 text-center pb-5'><strong>Answer</strong> matrix (3x3)<div class='row d-flex justify-content-center'><input id='matAB_11' placeholder='ans' readonly class='form-control m-1' style='text-align: center; width: 100px;'> <input id='matAB_12' placeholder='ans' readonly class='form-control m-1' style='text-align: center; width: 100px;'> <input id='matAB_13' placeholder='ans' readonly class='form-control m-1' style='text-align: center; width: 100px;'></div><div class='row d-flex justify-content-center'><input id='matAB_21' placeholder='ans' readonly class='form-control m-1' style='text-align: center; width: 100px;'> <input id='matAB_22' placeholder='ans' readonly class='form-control m-1' style='text-align: center; width: 100px;'> <input id='matAB_23' placeholder='ans' readonly class='form-control m-1' style='text-align: center; width: 100px;'></div><div class='row d-flex justify-content-center'><input id='matAB_31' placeholder='ans' readonly class='form-control m-1' style='text-align: center; width: 100px;'> <input id='matAB_32' placeholder='ans' readonly class='form-control m-1' style='text-align: center; width: 100px;'> <input id='matAB_33' placeholder='ans' readonly class='form-control m-1' style='text-align: center; width: 100px;'></div></div></div>"
        }
}